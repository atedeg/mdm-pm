...
Il progetto è stato sviluppato secondo la metodologia del \emph{Domain Driven Design}\todo{cit} facendo ampio uso di \emph{Event Storming}\todo{cit} per gestire la comunicazione con i committenti e la raccolta dei requisiti. \todo[inline]{Mettere gli strumenti usati da qualche parte (e.g. github projects)}
