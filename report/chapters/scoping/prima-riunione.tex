...
\subsubsection{Svolgimento della riunione - kick off}
...
\subsubsection{Svolgimento della riunione - esplorazione caotica}
...
\todo[inline]{Sostituire con le swimlanes}
Per riordinare i vari cluster di eventi è utile individuare i cosiddetti \emph{pivotal events}: degli eventi che riguardano più silos aziendali e che possono essere usati come riferimento per l'ordinamento. Generalmente sono sufficienti pochi eventi chiave per permettere un riordinamento efficace, un esempio è mostrato in \Cref{fig:event-storming-pivotal-events}
...
\subsubsection{Svolgimento della riunione - walkthrough esplicito}
...
Il risultato finale è mostrato in \Cref{TODO} \todo[inline]{Aggiugnere cartellone leggermente corretto con i pain point adatti al nostro progetto} e tutto il processo che ha portato alla sua realizzazione può essere visto al \href{https://youtu.be/BvkPYtI8MF8}{seguente video}.
